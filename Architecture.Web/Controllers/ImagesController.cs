...
namespace Architecture.Web.Controllers
{
    ...
    public class ImagesController : BaseController
    {
        ...
        public ImagesController(IHostEnvironment hostEnvironment, IModelMetadataProvider modelMetadataProvider, SiteConfiguration siteConfiguration, IOptions<AzureStorageConfig> config, IOptions<AWSBucketConfig> awsBucketConfig) : base(hostEnvironment, modelMetadataProvider, siteConfiguration)
        {
